...
public class LuckPerms5WeightProvider implements Function<ProxiedPlayer, Integer> {
    ...
    public Integer apply(ProxiedPlayer player) {
        ...
        CachedMetaData metaData = data.getMetaData(QueryOptions.contextual(context));

        String value = metaData.getMetaValue("weight");
