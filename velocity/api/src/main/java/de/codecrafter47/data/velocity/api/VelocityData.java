...
public class VelocityData implements DataKeyCatalogue {
    public final static Scope SCOPE_VELOCITY_PLAYER = new Scope("velocity:player");
    public final static Scope SCOPE_VELOCITY_SERVER = new Scope("velocity:server");
    public final static Scope SCOPE_VELOCITY_PROXY = new Scope("velocity:proxy");

    // Velocity player data keys
    public final static DataKey<String> Velocity_DisplayName = new DataKey<>("velocity:displayname", SCOPE_VELOCITY_PLAYER, TypeToken.STRING);
    public final static DataKey<Integer> Velocity_Ping = new DataKey<>("velocity:ping", SCOPE_VELOCITY_PLAYER, TypeToken.INTEGER);
    public final static DataKey<Boolean> Velocity_Permission = new DataKey<>("velocity:permission", SCOPE_VELOCITY_PLAYER, TypeToken.BOOLEAN);
    ...
    public final static DataKey<String> Velocity_Server = new DataKey<>("velocity:server", SCOPE_VELOCITY_PLAYER, TypeToken.STRING);
