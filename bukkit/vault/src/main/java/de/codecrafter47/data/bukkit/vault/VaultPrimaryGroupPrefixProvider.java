...
public class VaultPrimaryGroupPrefixProvider extends VaultDataProvider<Player, String> {
            ...
            if (chat != null && chat.isEnabled()) {
                try {
                    ...
                    if (primaryGroup != null) {
                        return chat.getGroupInfoString(player.getWorld(), primaryGroup, "prefix", null);
                    }
